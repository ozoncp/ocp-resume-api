...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-resume-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-resume-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-resume-api/bin/ocp-resume-api .
RUN chown root:root ocp-resume-api
EXPOSE 82
CMD ["./ocp-resume-api"]